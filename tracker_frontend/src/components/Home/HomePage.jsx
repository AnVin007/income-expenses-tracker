...
const HeroSection = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-gray-400 to-white-500 text-black-300 py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-black-300 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
